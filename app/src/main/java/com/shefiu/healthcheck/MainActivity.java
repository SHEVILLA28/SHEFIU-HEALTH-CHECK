...
public class MainActivity extends Activity {
 ...
 @Override public void onCreate(Bundle state){super.onCreate(state);setContentView(R.layout.activity_main);
  home=findViewById(R.id.home);scan=findViewById(R.id.scan);questions=findViewById(R.id.questions);output=findViewById(R.id.output);camera=findViewById(R.id.camera);bpm=findViewById(R.id.bpm);scanStatus=findViewById(R.id.scan_status);timer=findViewById(R.id.timer);signal=findViewById(R.id.signal);progress=findViewById(R.id.scan_progress);text=findViewById(R.id.text); medscreen=findViewById(R.id.medscreen); medtext=findViewById(R.id.medtext);
  findViewById(R.id.start).setOnClickListener(v->askCamera()); findViewById(R.id.medicine).setOnClickListener(v->showMedicine()); findViewById(R.id.medback).setOnClickListener(v->show(home));findViewById(R.id.finish).setOnClickListener(v->finishScan());findViewById(R.id.result).setOnClickListener(v->makeResult());findViewById(R.id.again).setOnClickListener(v->show(home));findViewById(R.id.cancel_scan).setOnClickListener(v->{stopCam();show(home);});
 }
